(() => {
    ...
    (() => {
        ...
        da.init();
        const selectBtn = document.getElementById("select-header-btn");
        const script_text = document.getElementById("header-text");
        const script_option = document.getElementsByClassName("language-header__option");
